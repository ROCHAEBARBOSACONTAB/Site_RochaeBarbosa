...
const MEETING_IMG =
  "https://images.pexels.com/photos/7433840/pexels-photo-7433840.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940";
    ...
    <div data-testid="home-page">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(10,42,87,0.92)_0%,rgba(10,42,87,0.86)_30%,rgba(10,42,87,0.70)_55%,rgba(10,42,87,0.52)_75%,rgba(10,42,87,0.62)_100%)]" />
         ...
         <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12 pt-24 pb-18 lg:pt-32 lg:pb-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-white/72 text-[16.5px] max-w-[700px] leading-[1.5]">
              Identificamos falhas invisíveis entre sistema, apuração e obrigações fiscais — corrigindo inconsistências com precisão técnica e impacto financeiro mensurável.
            </p>  
            <p className="mt-4 text-white/50 text-[13px]">
              Atuação em operações com alto volume fiscal e ambientes ERP complexos
            </p>
            <div className="fade-up-4 mt-7 flex flex-wrap gap-4">
              <Link
                to="/diagnostico"
                data-testid="hero-cta-diagnostic"
                className="btn-gold"
              >
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="max-w-[900px] mb-14">
            ...
            <h2 className="font-serif text-3xl lg:text-5xl text-[#0A2A57] leading-[1.08]">
              ...
              <span className="text-[#D4AF37]">
                {" "}e o sistema não mostra isso
              </span>
            </h2>

            <p className="mt-6 text-[#4B5563] text-[16px] lg:text-[17px] leading-relaxed max-w-[760px]">
              Esses erros raramente aparecem no resultado de imediato, mas
              acumulam impacto real em créditos, apuração, obrigações fiscais e
              decisões de gestão.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            {[
              ...
              >
                <div
                  className="text-[12px] uppercase tracking-[0.24em] text-[#D4AF37] mb-5
                ...
                <h3
                  className="font-serif text-[26px] leading-[1.12] text-[#0A2A57] mb-4 min-h-[104px]
                transition-all duration-300
                ...
                <p
                  className="text-[#5B6470] text-[15px] leading-relaxed
                transition-all duration-300
          ...
          <div className="mt-12 text-center">
            <p className="text-[#4B5563] mb-5 leading-relaxed">
              Se algum desses pontos existe na sua operação, sua empresa já pode
              estar exposta a perdas, retrabalho e risco fiscal oculto.
            </p>

            <Link to="/servicos" className="btn-outline-gold">
              Ver como corrigimos isso
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-5">
              <div className="eyebrow mb-4">Método de Atuação</div>

              <h2 className="font-serif text-3xl lg:text-5xl text-[#0A2A57] leading-[1.08]">
                Um processo estruturado para
                <span className="text-[#D4AF37]">
                  {" "}identificar, corrigir e sustentar
                </span>
                {" "}sua operação fiscal
              </h2>

              <p className="mt-6 text-[#444] text-[16px] leading-relaxed max-w-[520px]">
                Entramos na operação, identificamos os pontos críticos e atuamos
                diretamente na correção e estruturação fiscal — conectando
                contabilidade, obrigações e ERP com base técnica e segurança.
              </p>
            ...
            <div className="lg:col-span-7 space-y-5">
              {[
                {
                  icon: FileSearch,
                  title: "1. Diagnóstico Fiscal e Operacional",
                  desc: "Mapeamos a operação, localizamos distorções, riscos e perdas invisíveis cruzando ERP, escrituração e obrigações.",
                },
                {
                  icon: TrendingUp,
                  title: "2. Recuperação e Correção de Impacto",
                  desc: "Identificamos oportunidades concretas de recuperação, corrigimos a origem do problema e reduzimos a repetição do erro.",
                },
                {
                  icon: ShieldCheck,
                  title: "3. Estruturação e Compliance Contínuo",
                  desc: "Fortalecemos a base fiscal, organizamos processos e sustentamos a operação para crescer com controle e menos exposição.",
                },
              ].map((s, i) => (
                <Link
                  to="/servicos"
      ...
      <section className="bg-[#F1EFEA] py-24 border-t border-black/5">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <p className="text-[#555] text-[16px] max-w-[760px] mx-auto text-center mt-4 leading-relaxed">
            Atuamos diretamente na estruturação, validação e execução fiscal em
            ambientes que exigem precisão técnica, governança e integração com
            ERP — especialmente em operações que não podem depender de tentativa
            e erro.
          </p>
          ...
          <p className="text-[#6B7280] text-[14px] text-center mt-12 max-w-[760px] mx-auto leading-relaxed">
            Atuamos com profundidade técnica em ambientes complexos, com domínio
            avançado de ERP — especialmente em operações que utilizam Protheus —
            garantindo consistência fiscal, segurança e controle real da
            operação.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-24 border-t border-[#EAE6DC]">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="text-center max-w-[760px] mx-auto">
            <div className="eyebrow mb-3">Soluções Estratégicas</div>

            <h2 className="font-serif text-3xl lg:text-4xl text-[#0A2A57]">
              Apoio completo para operações que exigem controle fiscal real
            </h2>

            <p className="text-[#555] text-[16px] mt-4 leading-relaxed">
              Soluções aplicadas para otimização fiscal, recuperação de valores,
              adequação sistêmica e evolução da governança operacional.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  desc: "Estratégias para redução legal da carga tributária com análise técnica, projeção de cenários e segurança na tomada de decisão.",
                },
                {
                  title: "Recuperação Fiscal",
                  desc: "Identificação e recuperação de créditos tributários com base documental, rastreabilidade e correção da origem do problema.",
                },
                {
                  title: "Reforma Tributária",
                  desc: "Preparação da empresa para o novo modelo tributário com análise de impacto, adaptação operacional e revisão sistêmica.",
                },
              ].map((item, i) => (
                <Link
                  key={i}
              ...
              {[
                {
                  ...
                  desc: "Emissão ágil, suporte completo e condições competitivas para empresas e pessoas físicas — com orientação para uso seguro.",
                },
                {
                  title: "ERP & Sistemas",
                  desc: "Atuação em diferentes plataformas com foco em integração, parametrização e consistência fiscal da operação.",
                },
              ].map((item, i) => (
                <Link
                  key={i}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
            ...
            <Link
              to="/blog"
              className="link-gold text-sm uppercase tracking-[0.18em]"
            >
              Ver todos →
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-7">
            {posts.map((p, i) => (
              ...
              >
                ...
                <div className="p-6">
                  <div className="text-[10px] uppercase tracking-[0.22em] text-[#A67C00] mb-3">
                    {p.category} · {p.read_time}
                  </div>

                  <h3 className="font-serif text-[20px] leading-snug text-[#0A2A57] group-hover:text-[#0E4A8A]">
                    {p.title}
                  </h3>
      ...
      <section className="bg-[#0A2A57] text-white py-24 relative noise">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-12 text-center">
          ...
          <h2 className="font-serif text-3xl lg:text-5xl leading-[1.08] mb-6">
            Decisões fiscais tomadas sem diagnóstico
            <span className="text-[#D4AF37]">
              {" "}geram prejuízos que só aparecem depois
            </span>
          </h2>

          <p className="text-white/75 max-w-2xl mx-auto mb-8 leading-relaxed">
            O diagnóstico técnico inicial avalia a estrutura fiscal da empresa
            com base em dados reais, identificando inconsistências, pontos de
            exposição e possibilidades de recuperação ou melhoria operacional.
          </p>
          ...
          <p className="mt-5 text-xs text-white/45 max-w-xl mx-auto leading-relaxed">
            A análise é conduzida conforme a complexidade da operação e o volume
