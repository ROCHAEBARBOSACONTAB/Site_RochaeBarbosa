  ...
  return (
    <div data-testid="anexo4-page" className="bg-white">
      ...
      <SimplesTablesByValidity
        annexPath="/recursos/simples-nacional/anexo-4"
        current={{
          aliquotas,
          reparticao,
          reparticaoColumns: ["faixa", "irpj", "csll", "cofins", "pis", "cpp", "iss"],
        }}
        periods={transitionTables.anexo4}
      />

      {/* Legado de referência para as regras específicas atuais. */}
      ...
      <section className="py-14 bg-white border-t border-[#0A2A57]/10">
        <div className="max-w-[1000px] mx-auto px-6">
          ...
          <SimplesLegalBasis
            annexTitle="Anexo IV — Serviços com CPP fora do DAS"
            legalAnnex="Anexo XXI"
          />
